(function($) {
	...
	$(document).ready(function() {
		...
		//Also inherits basic Backbone view stuff
		...
		Backbone.history.start(); //{ pushState: true } use traditinoal URLs instead of hashmark
	
		//App.navigate('blank', true); in console to programmatically change the url
		});
